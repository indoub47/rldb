...
// kmvItems
export const KMVITEM_FETCH_BEGIN = "KMVITEM_FETCH_BEGIN";
export const KMVITEM_FETCH_SUCCESS = "KMVITEM_FETCH_SUCCESS";
export const KMVITEM_FETCH_FAILURE = "KMVITEM_FETCH_FAILURE";
export const KMVITEM_EDIT = "KMVITEM_EDIT";
export const KMVITEM_PROPOSE_BEGIN = "KMVITEM_PROPOSE_BEGIN";
export const KMVITEM_PROPOSE_SUCCESS = "KMVITEM_PROPOSE_SUCCESS";
export const KMVITEM_PROPOSE_FAILURE = "KMVITEM_PROPOSE_FAILURE";
export const KMVITEM_UPDATE_BEGIN = "KMVITEM_UPDATE_BEGIN";
export const KMVITEM_UPDATE_SUCCESS = "KMVITEM_UPDATE_SUCCESS";
export const KMVITEM_UPDATE_FAILURE = "KMVITEM_UPDATE_FAILURE";
export const KMVITEM_UNAPPROVED_PROPOSALS_FETCH_BEGIN = "KMVITEM_UPDATE_FAILURE";
export const KMVITEM_UNAPPROVED_PROPOSALS_FETCH_SUCCESS = "KMVITEM_UPDATE_FAILURE";
export const KMVITEM_UNAPPROVED_PROPOSALS_FETCH_FAILURE = "KMVITEM_UPDATE_FAILURE";